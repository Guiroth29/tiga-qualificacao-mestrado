...
%=====================================================
% Configuração do pacote background
\backgroundsetup{
  scale=1,
  color=black,
  opacity=0.5,
  ...
  vshift=0cm, % Ajusta a posição vertical da imagem
  hshift=0cm, % Ajusta a posição horizontal da imagem
  contents={\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{0-iniciais/fundo-capa.png}}
}
...
% título
\title{\rev{TIGA: uma Taxonomia Multidimensional para a Integração da Inteligência Artificial Generativa na Produção Audiovisual Não Interativa}}
...
\pchave{Inteligência Artificial Generativa, Audiovisual Não Interativo, Mapeamento Sistemático da Literatura, Taxonomia, Produção Audiovisual{\color{red}, TIGA}}
\keyword{Generative Artificial Intelligence, Non-interactive Audiovisual, Systematic Literature Mapping, Taxonomy, Audiovisual Production{\color{red}, TIGA}}


% autoria
\author{\href{mailto:guilherme.roth@ufpr.br}{Guilherme de Queiroz Lima Roth}}
\advisor{Natasha Malveira Costa Valentim}
\coadvisor{Rafael de Andrade de Pereira}
...
\descr{Trabalho apresentado como requisito parcial à obtenção do titulo de Mestre em Informática, no Programa de Pós-Graduação em Informática, da Universidade Federal do Paraná}
...
\include{2-fundamentacaoTeorica/texto}		    % fundamentação teórica
\include{MSL/texto}			% trabalhos relacionados
\include{3-taxonomia/texto}    % Resultados Pesquisa Quantitativa
% \include{4-discussao/texto}     % Discussao
\include{5-conclusao/texto}     % Conclusao

% \include{3-contexto/texto}	% Conxtexto
% \include{4-objetivo/texto}	% Objetivo
