...
% título
\title{TIGA: uma Taxonomia Multidimensional para a Integração da Inteligência Artificial Generativa na Produção Audiovisual Não Interativa}
...
\pchave{Inteligência Artificial Generativa, Audiovisual Não Interativo, Mapeamento Sistemático da Literatura, Taxonomia, Produção Audiovisual, TIGA}
\keyword{Generative Artificial Intelligence, Non-interactive Audiovisual, Systematic Literature Mapping, Taxonomy, Audiovisual Production, TIGA}
