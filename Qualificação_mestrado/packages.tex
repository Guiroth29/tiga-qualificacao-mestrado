...
\usepackage{multirow}
\usepackage{xcolor}		% marcações temporárias de revisão (\textcolor{red}{...})
% Marcação de revisão robusta: use \rev{...} dentro de títulos e \caption,
% onde {\color{red}...} é quebrado pelo \MakeUppercase da classe.
\DeclareRobustCommand{\rev}[1]{{\color{red}#1}}
\usepackage{array}		% colunas p{} com >{\raggedright\arraybackslash} 
...
\usepackage{longtable} % Para funcionar a tabela dos resultados
\usepackage{booktabs}  % Para funcionar a tabela dos resultados
\usepackage{geometry}  % Para funcionar a tabela dos resultados

% diagramas e fluxogramas
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, arrows.meta, positioning, calc}

% tentando colocar capa
\usepackage{graphicx}
